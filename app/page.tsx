  ...
  return (
    <main className="min-h-[100svh] flex flex-col justify-center items-center px-4 font-jakarta">
      <div className="w-full max-w-md mx-auto flex flex-col items-center space-y-4">
        ...
        <Link href="/quiz/1">
          <button className="bg-gradient-to-b from-neutral-900 to-neutral-800 text-white px-0 py-5 rounded-lg shadow-md hover:opacity-90 transition text-2xl font-semibold w-[90vw] max-w-[500px] mx-auto block active:scale-95" style={{ transition: 'box-shadow, transform 0.15s' }}>
            Begin
          </button>
        </Link>
      </div>
