  ...
  return (
    <main className="min-h-[100svh] flex flex-col justify-center items-center px-4 font-jakarta">
      <div className="w-full max-w-md mx-auto flex flex-col items-center space-y-4">
        ...
        <Link href="/quiz/1">
          <button className="bg-gradient-to-b from-neutral-900 to-neutral-800 text-white px-8 py-3 rounded-lg shadow-md hover:opacity-90 transition text-lg font-semibold w-full">
            Begin
          </button>
        </Link>
      </div>
